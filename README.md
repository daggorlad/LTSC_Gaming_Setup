...
Here’s the complete **minimal README** with everything included:
...
Never blindly execute scripts from the internet (or any source).

**Recommended inspection steps:**
1. Open the raw file:  
   https://raw.githubusercontent.com/daggorlad/LTSC_Gaming_Setup/refs/heads/main/LTSC_Gaming_Setup.ps1
2. Scan it on [VirusTotal](https://www.virustotal.com) (paste the URL or the code).
3. Manually read the code and check for suspicious activity.
4. Only run it once you understand it and the scan is clean.
